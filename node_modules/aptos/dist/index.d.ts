...
declare class AccountsService {
     ...
     * @throws ApiError
     */
    getAccountResources(address: Address, ledgerVersion?: U64$1): CancelablePromise<Array<MoveResource>>;
    /**
     * Get account modules
     ...
     * @throws ApiError
     */
    getAccountModules(address: Address, ledgerVersion?: U64$1): CancelablePromise<Array<MoveModuleBytecode>>;
    /**
...
declare class EventsService {
     ...
     * @throws ApiError
     */
    getEventsByEventKey(eventKey: EventKey, start?: U64$1, limit?: number): CancelablePromise<Array<VersionedEvent>>;
    /**
...
declare class TransactionsService {
     ...
     * @throws ApiError
     */
    simulateTransaction(requestBody: SubmitTransactionRequest, estimateMaxGasAmount?: boolean, estimateGasUnitPrice?: boolean): CancelablePromise<Array<UserTransaction$1>>;
    /**
     * Encode submission
...
type index$2_EventKey = EventKey;
...
declare const index$2_$EventKey: typeof $EventKey;
...
declare class AptosClient {
     ...
     */
    getEventsByEventKey(eventKey: string): Promise<Event[]>;
    /**
     * Event types are globally identifiable by an account `address` and
     * monotonically increasing `creation_number`, one per event type emitted
     * to the given account. This API returns events corresponding to that
     ...
     *
     */
    simulateTransaction(accountFrom: AptosAccount, rawTransaction: RawTransaction, query?: {
